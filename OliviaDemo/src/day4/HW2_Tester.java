...
class HW2_Tester {
    public static void main(String[] args) {
        ...
        MathVector.vec3DfromPolar(4, Math.PI / 6, Math.PI / 3).print(); //WHY IS THIS OUTPUTTING SOMETHING ELSE HOW TO FIX
...
//         fun(1);
//         fun(2,3);
//         fun(1,2,3,2,1,4,5,6,7,8,9,6,7,8,6,4);
//         fun("hello",2);
    }
    
    public static void fun(int... params) {
    	//treat params as array
