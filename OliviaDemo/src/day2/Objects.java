...
//         functionsAndObjects();
    ...
    public static void arrays() {
        ...
        */
        ...
        //int a = 10;//stack
        //int[] referenceToArrayOfInts = new int[8];		//referenceToArrayOfInts:stack    new part:heap
//stack  heap
...
//        referenceToArrayOfInts = {2, 3, 5, 7, 11, 13, 17, 19};
      referenceToArrayOfInts = new int[] {2, 3, 5, 7, 11, 13, 17, 19};
        ...
        */
        ...
        //== for objects are comparing memory address
        System.out.println(arr0 == arr1);     // false! (since different arrays are referenced)
        System.out.println(arr1 == arr2);
        //Arrays: the tool of Array object
        //							compare the element value in two arrays
        ...
        //parameter:
        //1:which array to fill
        //2:from which index(include)
        //3:to which index(not include)
        //4:replaced by what value
...
//        System.out.println(arr0);
        ...
        //	when you copy, the newLenght is less equals than the original lenght, then copy whatever you have
        // but if new lenght is longer, then copy everything , and fill the extra position with default value
    ...
    public static void functionsAndObjects() {
        /*
          ...
          Therefore, I strongly suggest that you watch from 15:05 to 50:18
          of the PIC 10A lecture video entitled "More on functions".
          ...
          The picture associated to such code is the most useful aspect of all this.
          I (will) draw such pictures in lecture. If I were you,
          copying those pictures is how I would take notes;
          understanding those pictures is how I would learn.


          Using the procedure above and/or the picture associated to it,
          one can understand the following function calls.
