    ...
    public static void main(String[] args) {
        ...
        */
        ...
        /*
          ...
          one could (incorrectly) guess that b is a short. only focusing on 
          this line, there is not way to deduce a (non-trivial) conversion occurred

          Widening conversions can be performed implicitly

          Widening is fairly safe, OFTEN no information is lost
        */
        ...
        */
        ...
        /*
          We can now prove that the following conversions can lose information. (even though this is widening)
