...
class VariablesOfPrimitiveType {
    public static void main(String[] args) {
        ...
        */
        ...
        //int has 4 byte , 1 byte = 8 bit   2^8    0 = 2^0
      ...
      */
        ...
        */
        ...
        double d5 = 1.000_000_000_000_0001;
...
//         PI = 4;      // compiler-time error
        ...
        */
        ...
        System.out.println(10<=10);				//<=  less or equals
        System.out.println("--------------------");
        
        //both sides have to be true, then the result is true
        System.out.println(true&&true);			//true
        System.out.println(false&&true);			//false
        System.out.println(true&&false);			//false
        System.out.println(false&&false);			//true
        
        //one side is true, then the result is true
        System.out.println(true||true);			//true
